# $Id: tc_iterator_test.rb 100 2006-12-29 11:09:07Z stefan $

# Taken from: http://svn.ruby-lang.org/repos/ruby/tags/v1_8_5_9/test/ruby/test_iterator.rb
...
class TcIteratorTest < Test::Unit::TestCase
  def ttt
    assert(iterator?)
  end
